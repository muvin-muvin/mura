import { Briefcase, Users, MessageSquare, Settings, LogOut, Bell } from "lucide-react";
        ...
        <main className="flex-1 p-8">
          <div className="max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-white rounded-xl border border-gray-300 p-6">
                <p className="text-gray-600 text-sm mb-2">Candidates Reviewed</p>
            ...
            <div className="bg-white rounded-xl border border-gray-300 p-8 text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Manage your job postings, review candidate applications, track your
                hiring pipeline, and communicate with top talent. Build out this
                section with job posting forms, candidate filters, and analytics!
              </p>
